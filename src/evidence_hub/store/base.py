...
class Store(Protocol):
    ...
    # tenant=None means "all tenants" (admin / cross-tenant view).
    def list_packs(self, tenant: Optional[str] = None) -> list[AuditPack]: ...
    def list_decision_ids(self, tenant: Optional[str] = None) -> list[str]: ...
